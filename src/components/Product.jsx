  ...
  return (
    <div className="product">
      ...
      <div className="product-container">
        ...
        <Box image={image3} name="Water Melon" price="$43.3" />
        <Box image={image4} name="Water Melon" price="$53.3" />
        <Box image={image5} name="Water Melon" price="$63.3" />
        <Box image={image6} name="Water Melon" price="$73.3" />
      </div>
    </div>
  );
}
